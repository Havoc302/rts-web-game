...
export const SERVICE_CONFIG = {
  ...
  [SERVICE_TYPE.CLINIC]: {
    ...
    cost: 2000,
    color: '#34d399',
    radius: { light: 10, medium: 10, high: 10 },
    jobs: { light: 5, medium: 5, high: 5 },
    popThresholds: { medium: Infinity, high: Infinity },
    maxPopulationServed: 5000,
    officersPerPopulation: 1000,
    utilityUsage: { power: 1, water: 1, sewage: 1 },
    runningCost: { light: 20, medium: 20, high: 20 },
    runningCostPerJob: 4,
    unique: false,
  },
  [SERVICE_TYPE.SCHOOL]: {
    ...
    jobs: { light: 10, medium: 25, high: 40 },
    popThresholds: { medium: 1000, high: 3500 },
    officersPerPopulation: 187,
    utilityUsage: { power: 1, water: 1, sewage: 1 },
    runningCost: { light: 20, medium: 50, high: 80 },
    runningCostPerJob: 2,
    unique: false,
  },
